...
@export var hover_scale: bool = false
## Scale will change relative to the button's scale based on the value entered.
@export var hover_scale_amount: Vector2 = Vector2(1.0, 1.0)
...
@export var hover_move: bool = false
...
@export var pressed_scale: bool = false
## Scale will change relative to the button's scale based on the value entered.
@export var pressed_scale_amount: Vector2 = Vector2(1.0, 1.0)
...
@export var pressed_move: bool = false
## Position will move relative to the button's position based on the X/Y entered.
		...
		if self.has_focus() && focusable:
			...
			if current_state == BaseButton.DRAW_HOVER: # Hover State
				...
				if hover_move:
					...
					tween_position.tween_property(self, "position", starting_position + hover_move_amount, hover_move_tween_duration)
				if hover_rotate:
					tween_rotation = create_tween()
					tween_rotation.tween_property(self, "rotation_degrees", starting_rotation + hover_rotate_amount, hover_rotate_tween_duration)
				if hover_grow:
